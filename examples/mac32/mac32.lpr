{
    "FloorplanScriptLocation": "/storage/programming/asic/luna_pnr/examples/mac32/mac32_floorplan.py",
    "LEF": [
    ...
    "Timing": [
        "/storage/programming/asic/luna_pnr/examples/mac32/mac32.sdc"
    ],
    "Verilog": [
        "/storage/programming/asic/luna_pnr/examples/mac32/mac32_netlist.v"
    ]
}
