{
    "FloorplanScriptLocation": "/storage/programming/asic/luna_pnr/examples/adder8/adder8_floorplan.py",
    "LEF": [
    ...
    "Timing": [
        "/storage/programming/asic/luna_pnr/examples/adder8/adder8.sdc"
    ],
    "Verilog": [
        "/storage/programming/asic/luna_pnr/examples/adder8/adder8_netlist.v"
    ]
}
